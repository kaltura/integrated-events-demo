...
function navigationClick(event) {
    ...
    event.srcElement.classList.add('active');
     // Handle xhrlogs visibility
     const xhrlogs = document.querySelector('.xhrlogs');
     if (event.srcElement.getAttribute('href') === 'pages/entry-view/index.html') {
         xhrlogs.style.display = 'block';
     } else {
         xhrlogs.style.display = 'none';
     }
